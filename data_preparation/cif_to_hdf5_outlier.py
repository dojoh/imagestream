...
if __name__ == '__main__':
    cif_dir = '/home/dojoh/projects/postdoc/testdata/2023.02.22-anhclean2/CRP/'
    ...
    clean_tasks = ["median", "normalize", "pca_orientation",  "cut"]
    ...
    for cif_file in cif_files:
            ...
            hf = h5py.File(os.path.join(cif_file.parent, cif_file.stem + '_' + export_name + '.h5'), 'w')
